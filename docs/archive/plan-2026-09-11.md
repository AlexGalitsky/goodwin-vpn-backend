> **Архив.** Продуктовая рамка на 2026-09-11. Живые ops: [`../ops.md`](../ops.md). Очередь: [client work-plan](https://github.com/AlexGalitsky/goodwin-vpn-client/blob/main/docs/work-plan.md).
